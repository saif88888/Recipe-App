...
const favoirateContainer = document.getElementById('fav-meals');
...
<button class="clear"><i class="far fa-window-close"></i></button>
	...
	favoirateContainer.appendChild(favMeal);
}
...
function showMealInfo(mealData) {
	...
	<h3>Youtube:
	<a href="${mealData.strYoutube}"><h3><i class="fab fa-youtube"></i><h3>
	</a>
	</h3>
	<h3>Ingredients:</h3>
	<ul>
